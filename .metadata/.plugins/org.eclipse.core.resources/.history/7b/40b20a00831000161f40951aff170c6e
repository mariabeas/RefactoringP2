...
public class polinomioTest {
	...
	public void routhTest() {
		...
		solu1 = solu1 + "Sistema inestable --> dos ra�ces positivas (hay dos cambios de signo en primera columna)";
		...
		solu3 = solu3 + "Sistema cr�ticamente estable -->" + "\n";
		solu3 = solu3 + "Fila cero" + "\n";
		solu3 = solu3 + "No hay ra�ces positivas";
		...
		solu4 = solu4 + "S1-->" + "\t" + "3.00" + "\t" + "\n";
		solu4 = solu4 + "S0-->" + "\t" + "6.00" + "\t" + "\n";
		solu4 = solu4 + "Sistema inestable --> dos ra�ces positivas (hay dos cambios de signo en primera columna)";
		...
		solu5 += "S1-->" + "\t" + "8.67" + "\t" + "\n";
		solu5 += "S0-->" + "\t" + "124.00" + "\t" + "\n";
		solu5 += "Sistema estable --> no hay ra�ces en semiplano derecho";

		assertEquals(solu5, treeResult6);

		// Caso 6, Degeneraci�n en el c�lculo
		...
		solu6 += "S3-->" + "\t" + "0.00" + "\t" + "2.00" + "\t" + "\n";
		solu6 += "Degeneraci�n en el C�lculo --> Primer elemento de fila es cero";
